        ...
        <file name="index.html">
            ...
            <div class="ui segment form" ng-controller="demoCtrl as ctrl">
                <div class="fields">
                    ...
                    <div class="eight wide field">
                        <div sui-select ajax-url="../json/form-options-country.json" label="From: " selected="ctrl.ajaxSelected" default-option="Click to fetch country list" searchable="true"></div>
                    </div>
                </div>
                <div class="ui positive message">
                    Country: {{ ctrl.selected }}; From: {{ ctrl.ajaxSelected }}
                </div>
            <div>
        </file>
        <file name="app.js">
